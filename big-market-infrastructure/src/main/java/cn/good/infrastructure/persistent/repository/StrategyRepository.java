...
import static cn.good.types.enums.ResponseCode.UN_ASSEMBLED_STRATEGY_ARMORY;
...
//          从库中获得数据
    ...
    public StrategyEntity queryStrategyEntityByStrategyId(Long strategyId) {
        ...
        StrategyEntity strategyEntity = JSONObject.parseObject(JSON.toJSONString(redisService.getValue(cacheKey)),StrategyEntity.class);
    ...
    public void updateStrategyAwardStock(Long strategyId, Integer awardId) {
        ...
        strategyAward.setStrategyId(strategyId);
        strategyAward.setAwardId(awardId);
        strategyAwardDao.uodateStrategyAwardStock(strategyAward);
    }
