...
import cn.good.trigger.api.IDCCService;
...
public class DCCController implements IDCCService {
     ...
     * 更新配置
     * <p>
     * curl --request GET --url 'http://localhost:1000/api/v1/raffle/dcc/update_config?key=degradeSwitch&value=close'
     * curl --request GET --url 'http://localhost:1000/api/v1/raffle/dcc/update_config?key=degradeSwitch&value=open'
      * curl --request GET --url 'http://localhost:1000/api/v1/raffle/dcc/update_config?key=rateLimiterSwitch&value=open'
     */
