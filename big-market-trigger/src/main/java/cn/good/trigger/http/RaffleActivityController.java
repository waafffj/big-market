...
public class RaffleActivityController implements IRaffleActivityService {
     ...
     * <p>
     * curl --request GET \
     * --url 'http://localhost:1000/api/v1/raffle/activity/armory?activityId=100301'
     */
     ...
     * 入参：xiaofuge
     * <p>
     * curl -X POST http://localhost:1000/api/v1/raffle/activity/calendar_sign_rebate -d "userId=xiaofuge" -H "Content-Type: application/x-www-form-urlencoded"
     */
