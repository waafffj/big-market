...
import cn.good.domain.strategy.service.IRaffleAward;
import cn.good.domain.strategy.service.IRaffleRule;
...
public class RaffleStrategyController implements IRaffleStrategyService {
    ...
    /**
     * 策略装配，将策略信息装配到缓存中
     * <a href="http://localhost:3000/api/v1/raffle/strategy/strategy_armory">/api/v1/raffle/strategy/strategy_armory</a>
     *
    ...
    /**
     * 查询奖品列表
     * <a href="http://localhost:3000/api/v1/raffle/strategy/query_raffle_award_list">/api/v1/raffle/strategy/query_raffle_award_list</a>
     * 请求参数 raw json
     *
     ...
     * 查询策略抽奖权重规则
     * curl --request POST \
     * --url http://localhost:3000/api/v1/raffle/strategy/query_raffle_strategy_rule_weight \
    ...
    /**
     * 随机抽奖接口
     * <a href="http://localhost:3000/api/v1/raffle/strategy/random_raffle">/api/v1/raffle/random_raffle</a>
     *
