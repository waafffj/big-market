...
public class RaffleStrategyController implements IRaffleStrategyService {
     ...
     * 策略装配 将策略信息装配到缓存中
     * @param strategyId
     * <a href="http://localhost:1000/api/v1/raffle/strategy_armory">/api/v1/raffle/strategy_armory</a>
     * @return 装配结果
     */
    ...
    /**
     * 查询奖品列表
     * <a href="http://localhost:1000/api/v1/raffle/strategy/query_raffle_award_list">/api/v1/raffle/query_raffle_award_list</a>
     * 请求参数 raw json
     *
    ...
    /**
     * 随机抽奖接口
     * <a href="http://localhost:1000/api/v1/raffle/random_raffle">/api/v1/raffle/random_raffle</a>
     *
